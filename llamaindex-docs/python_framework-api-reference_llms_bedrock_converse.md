...
```
fromllama_index.llms.bedrock_converseimport BedrockConverse
...
```
 | 
```
classBedrockConverse(FunctionCallingLLM):
"""
    Bedrock Converse LLM.
    ...
    def_get_content_and_tool_calls(
        self,
