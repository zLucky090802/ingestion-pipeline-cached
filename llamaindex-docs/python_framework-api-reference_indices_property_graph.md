...
```
 |  
| --- | --- |  
###  ainsert_nodes [#](https://developers.llamaindex.ai/python/framework-api-reference/indices/property_graph/#llama_index.core.indices.VectorStoreIndex.ainsert_nodes "Permanent link")
...
```
 |  
| --- | --- |  
###  adelete_nodes [#](https://developers.llamaindex.ai/python/framework-api-reference/indices/property_graph/#llama_index.core.indices.VectorStoreIndex.adelete_nodes "Permanent link")
...
```
 |  
| --- | --- |  
###  adelete_ref_doc [#](https://developers.llamaindex.ai/python/framework-api-reference/indices/property_graph/#llama_index.core.indices.VectorStoreIndex.adelete_ref_doc "Permanent link")
