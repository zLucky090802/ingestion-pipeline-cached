...
Source code in `llama-index-integrations/graph_rag/llama-index-graph-rag-cognee/llama_index/graph_rag/cognee/graph_rag.py`  
| 
```
 18
 19
...
"""
    ...
    async defprocess_data(self, dataset_name: str = "main_dataset") -> None:
"""
        ...
        """
        fromcognee.modules.users.methodsimport get_default_user

        user = await get_default_user()
        await cognee_lib.cognify(dataset_name, user)

    async defrag_search(self, query: str) -> list:
"""
    ...
    async defsearch(self, query: str) -> list:
"""
    ...
    async defget_related_nodes(self, node_id: str) -> list:
"""
...
```
 |  
| --- | --- |  
###  add [#](https://developers.llamaindex.ai/python/framework-api-reference/graph_rag/cognee/#llama_index.graph_rag.cognee.CogneeGraphRAG.add "Permanent link")
...
| --- | --- | --- | --- |  
|  `data`  |  `Union[Document[](https://developers.llamaindex.ai/python/framework-api-reference/storage/storage_context/#llama_index.core.Document "Document \(llama_index.core.Document\)"), List[Document[](https://developers.llamaindex.ai/python/framework-api-reference/storage/storage_context/#llama_index.core.Document "Document \(llama_index.core.Document\)")]]`  |  The document(s) to be added to the graph. Can be a single Document or a list of Documents.  |  _required_  |  
...
```
 |  
| --- | --- |  
###  process_data [#](https://developers.llamaindex.ai/python/framework-api-reference/graph_rag/cognee/#llama_index.graph_rag.cognee.CogneeGraphRAG.process_data "Permanent link")
...
```
 |  
| --- | --- |  
###  rag_search [#](https://developers.llamaindex.ai/python/framework-api-reference/graph_rag/cognee/#llama_index.graph_rag.cognee.CogneeGraphRAG.rag_search "Permanent link")
...
```
 |  
| --- | --- |  
###  search [#](https://developers.llamaindex.ai/python/framework-api-reference/graph_rag/cognee/#llama_index.graph_rag.cognee.CogneeGraphRAG.search "Permanent link")
...
```
 |  
| --- | --- |  
###  get_related_nodes [#](https://developers.llamaindex.ai/python/framework-api-reference/graph_rag/cognee/#llama_index.graph_rag.cognee.CogneeGraphRAG.get_related_nodes "Permanent link")
...
```
 |  
| --- | --- |  
###  visualize_graph [#](https://developers.llamaindex.ai/python/framework-api-reference/graph_rag/cognee/#llama_index.graph_rag.cognee.CogneeGraphRAG.visualize_graph "Permanent link")
