...
```
 |  
| --- | --- |  
###  aget_response [#](https://developers.llamaindex.ai/python/framework-api-reference/response_synthesizers/tree_summarize/#llama_index.core.response_synthesizers.Accumulate.aget_response "Permanent link")
...
```
 |  
| --- | --- |  
###  aget_response [#](https://developers.llamaindex.ai/python/framework-api-reference/response_synthesizers/tree_summarize/#llama_index.core.response_synthesizers.TreeSummarize.aget_response "Permanent link")
