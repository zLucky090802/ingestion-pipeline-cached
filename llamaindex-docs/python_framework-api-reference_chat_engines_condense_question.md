...
```
 |  
| --- | --- |  
##  MultiModalCondensePlusContextChatEngine [#](https://developers.llamaindex.ai/python/framework-api-reference/chat_engines/condense_question/#llama_index.core.chat_engine.MultiModalCondensePlusContextChatEngine "Permanent link")
Bases: 
...
```
 |  
| --- | --- |  
###  chat_history `property` [#](https://developers.llamaindex.ai/python/framework-api-reference/chat_engines/condense_question/#llama_index.core.chat_engine.MultiModalCondensePlusContextChatEngine.chat_history "Permanent link")
...
Get chat history.
###  from_defaults `classmethod` [#](https://developers.llamaindex.ai/python/framework-api-reference/chat_engines/condense_question/#llama_index.core.chat_engine.MultiModalCondensePlusContextChatEngine.from_defaults "Permanent link")
