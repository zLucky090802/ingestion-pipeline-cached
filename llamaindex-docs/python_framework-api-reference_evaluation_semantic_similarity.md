...
```
 |  
| --- | --- |  
###  aevaluate [#](https://developers.llamaindex.ai/python/framework-api-reference/evaluation/semantic_similarity/#llama_index.core.evaluation.AnswerRelevancyEvaluator.aevaluate "Permanent link")
...
```
 |  
| --- | --- |  
###  aevaluate_response [#](https://developers.llamaindex.ai/python/framework-api-reference/evaluation/semantic_similarity/#llama_index.core.evaluation.BaseEvaluator.aevaluate_response "Permanent link")
...
| Name  | Type  | Description  | Default  |  
| --- | --- | --- | --- |  
|  `evaluators`  |  `Dict[str, BaseEvaluator[](https://developers.llamaindex.ai/python/framework-api-reference/evaluation/semantic_similarity/#llama_index.core.evaluation.BaseEvaluator "BaseEvaluator \(llama_index.core.evaluation.base.BaseEvaluator\)")]`  |  Dictionary of evaluators.  |  _required_  |  
...
```
 |  
| --- | --- |  
###  aevaluate_response_strs [#](https://developers.llamaindex.ai/python/framework-api-reference/evaluation/semantic_similarity/#llama_index.core.evaluation.BatchEvalRunner.aevaluate_response_strs "Permanent link")
...
```
 |  
| --- | --- |  
###  aevaluate_responses [#](https://developers.llamaindex.ai/python/framework-api-reference/evaluation/semantic_similarity/#llama_index.core.evaluation.BatchEvalRunner.aevaluate_responses "Permanent link")
...
```
 |  
| --- | --- |  
###  aevaluate_queries [#](https://developers.llamaindex.ai/python/framework-api-reference/evaluation/semantic_similarity/#llama_index.core.evaluation.BatchEvalRunner.aevaluate_queries "Permanent link")
...
```
 |  
| --- | --- |  
###  aevaluate [#](https://developers.llamaindex.ai/python/framework-api-reference/evaluation/semantic_similarity/#llama_index.core.evaluation.ContextRelevancyEvaluator.aevaluate "Permanent link")
...
```
 |  
| --- | --- |  
###  agenerate_questions_from_nodes [#](https://developers.llamaindex.ai/python/framework-api-reference/evaluation/semantic_similarity/#llama_index.core.evaluation.DatasetGenerator.agenerate_questions_from_nodes "Permanent link")
...
```
 |  
| --- | --- |  
###  agenerate_dataset_from_nodes [#](https://developers.llamaindex.ai/python/framework-api-reference/evaluation/semantic_similarity/#llama_index.core.evaluation.DatasetGenerator.agenerate_dataset_from_nodes "Permanent link")
...
```
 |  
| --- | --- |  
###  aevaluate [#](https://developers.llamaindex.ai/python/framework-api-reference/evaluation/semantic_similarity/#llama_index.core.evaluation.FaithfulnessEvaluator.aevaluate "Permanent link")
...
```
 |  
| --- | --- |  
###  aevaluate [#](https://developers.llamaindex.ai/python/framework-api-reference/evaluation/semantic_similarity/#llama_index.core.evaluation.GuidelineEvaluator.aevaluate "Permanent link")
...
```
 |  
| --- | --- |  
###  aevaluate [#](https://developers.llamaindex.ai/python/framework-api-reference/evaluation/semantic_similarity/#llama_index.core.evaluation.RelevancyEvaluator.aevaluate "Permanent link")
...
```
 |  
| --- | --- |  
###  aevaluate [#](https://developers.llamaindex.ai/python/framework-api-reference/evaluation/semantic_similarity/#llama_index.core.evaluation.BaseRetrievalEvaluator.aevaluate "Permanent link")
...
```
 |  
| --- | --- |  
###  aevaluate_dataset [#](https://developers.llamaindex.ai/python/framework-api-reference/evaluation/semantic_similarity/#llama_index.core.evaluation.BaseRetrievalEvaluator.aevaluate_dataset "Permanent link")
