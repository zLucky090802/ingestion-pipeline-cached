...
```
 |  
| --- | --- |  
###  async_add_source_text [#](https://developers.llamaindex.ai/python/framework-api-reference/retrievers/knowledge_graph/#llama_index.core.retrievers.BasePGRetriever.async_add_source_text "Permanent link")
...
```
 |  
| --- | --- |  
###  acustom_retrieve [#](https://developers.llamaindex.ai/python/framework-api-reference/retrievers/knowledge_graph/#llama_index.core.retrievers.CustomPGRetriever.acustom_retrieve "Permanent link")
...
| Name  | Type  | Description  | Default  |  
| --- | --- | --- | --- |  
|  `sub_retrievers`  |  `List[BasePGRetriever[](https://developers.llamaindex.ai/python/framework-api-reference/retrievers/knowledge_graph/#llama_index.core.retrievers.BasePGRetriever "BasePGRetriever \(llama_index.core.indices.property_graph.sub_retrievers.base.BasePGRetriever\)")]`  |  The sub-retrievers to use.  |  _required_  |  
...
```
 |  
| --- | --- |  
###  aretrieve_with_metadata [#](https://developers.llamaindex.ai/python/framework-api-reference/retrievers/knowledge_graph/#llama_index.core.retrievers.NLSQLRetriever.aretrieve_with_metadata "Permanent link")
