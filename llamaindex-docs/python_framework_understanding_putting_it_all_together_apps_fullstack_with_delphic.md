...
returnawait sync_to_async(CollectionModelSchema)(...)
...
constaccessToken= localStorage.getItem("accessToken");
...
constresponse=awaitgetMyCollections(accessToken);
