...
```
 |  
| --- | --- |  
###  aget_response [#](https://developers.llamaindex.ai/python/framework-api-reference/response_synthesizers/accumulate/#llama_index.core.response_synthesizers.Accumulate.aget_response "Permanent link")
...
```
 |  
| --- | --- |  
###  aget_response [#](https://developers.llamaindex.ai/python/framework-api-reference/response_synthesizers/accumulate/#llama_index.core.response_synthesizers.TreeSummarize.aget_response "Permanent link")
