...
```
 |  
| --- | --- |  
###  acustom_query [#](https://developers.llamaindex.ai/python/framework-api-reference/query_engine/citation/#llama_index.core.query_engine.CustomQueryEngine.acustom_query "Permanent link")
...
```
 |  
| --- | --- |  
###  agenerate_query [#](https://developers.llamaindex.ai/python/framework-api-reference/query_engine/citation/#llama_index.core.query_engine.KnowledgeGraphQueryEngine.agenerate_query "Permanent link")
