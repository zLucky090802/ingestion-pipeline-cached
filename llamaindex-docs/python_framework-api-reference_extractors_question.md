...
```
 |  
| --- | --- |  
###  aprocess_nodes [#](https://developers.llamaindex.ai/python/framework-api-reference/extractors/question/#llama_index.core.extractors.BaseExtractor.aprocess_nodes "Permanent link")
...
```
 |  
| --- | --- |  
###  acall [#](https://developers.llamaindex.ai/python/framework-api-reference/extractors/question/#llama_index.core.extractors.BaseExtractor.acall "Permanent link")
...
```
 |  
| --- | --- |  
###  aextract [#](https://developers.llamaindex.ai/python/framework-api-reference/extractors/question/#llama_index.core.extractors.PydanticProgramExtractor.aextract "Permanent link")
...
```
 |  
| --- | --- |  
###  aextract [#](https://developers.llamaindex.ai/python/framework-api-reference/extractors/question/#llama_index.core.extractors.DocumentContextExtractor.aextract "Permanent link")
