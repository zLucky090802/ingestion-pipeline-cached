...
"""
    ...
    def__init__(self, psychic_key: Optional[str] = None) -> None:
"""Initialize with parameters."""
        try:
            frompsychicapiimport ConnectorId, Psychic
        except ImportError:
            raise ImportError(
...
```
load_data(
    connector_id: Optional[] = None,
    account_id: Optional[] = None,
) -> []
