...
SharePoint reader.
Reads folders from the SharePoint site from a folder under documents. Also supports reading SharePoint Site Pages when sharepoint_type is set to PAGE.
Parameters:  
...
|  `sharepoint_type`  |   |  Type of content to load - DRIVE (files) or PAGE (site pages). Default is DRIVE.  |  `DRIVE`  |  
|  `sharepoint_host_name`  |  `Optional[str]`  |  The host name of the SharePoint site (e.g., 'contoso.sharepoint.com').  |  `None`  |  
|  `sharepoint_relative_url`  |  `Optional[str]`  |  The relative URL of the SharePoint site (e.g., '/sites/MySite').  |  `None`  |  
|  `process_document_callback`  |  `Optional[Callable[[str], bool]]`  |  Callback to filter documents before processing.  |  `None`  |  
|  `fail_on_error`  |  `bool`  |  If True, raise exceptions on errors. If False, log and continue. Default is True.  |  `True`  |  
...
"""
    ...
    def_send_request_with_retry(self, request: requests.Request) -> requests.Response:
"""
    ...
    def_send_get_with_retry(self, url: str) -> requests.Response:
    ...
    def_get_all_items_with_pagination(self, endpoint: str) -> List[Dict[str, Any]]:
"""
    ...
    def_get_site_id_with_host_name(
...
"""
    ...
    def_get_sharepoint_folder_id(self, folder_path: str) -> str:
"""
    ...
    def_download_files_and_extract_metadata(
        self,
        folder_id: str,
        download_dir: str,
...
"""
    ...
    def_get_file_content_by_url(self, item: Dict[str, Any]) -> bytes:
"""
    ...
    def_download_file_by_url(self, item: Dict[str, Any], download_dir: str) -> str:
"""
    ...
    def_get_permissions_info(self, item: Dict[str, Any]) -> Dict[str, str]:
"""
    ...
    def_extract_metadata_for_file(self, item: Dict[str, Any]) -> Dict[str, str]:
"""
    ...
    def_download_files_from_sharepoint(
        self,
        download_dir: str,
...
"""
    ...
    def_exclude_access_control_metadata(
...
"""
    ...
    def_list_drive_contents(self) -> List[Path]:
"""
...
"""
    ...
    def_get_item_from_path(self, input_file: Path) -> Dict[str, Any]:
"""
    ...
    defget_permission_info(self, resource_id: str, **kwargs) -> Dict:
"""
...
"""
    ...
    defget_site_pages_list_id(self, site_id: str) -> str:
"""
    ...
    deflist_pages(self, site_id: str) -> List[Dict[str, Any]]:
"""
    ...
    defget_page_id_by_name(self, site_id: str, page_name: str) -> Optional[str]:
"""
    ...
    defget_page_text(self, site_id: str, list_id: str, page_id: str) -> Dict[str, Any]:
"""
    ...
    @dispatcher.span
    defload_pages_data(self, download_dir: Optional[str] = None) -> List[Document]:
"""
...
```
load_data(
    sharepoint_site_name: Optional[] = None,
    sharepoint_folder_path: Optional[] = None,
    sharepoint_folder_id: Optional[] = None,
    recursive:  = True,
...
Loads data from SharePoint based on sharepoint_type. Handles both drive (files/folders) and page types.
Parameters:  
| Name  | Type  | Description  | Default  |  
| --- | --- | --- | --- |  
...
|  `sharepoint_folder_id`  |  `Optional[str]`  |  The ID of the folder in the SharePoint site.  |  `None`  |  
|  `recursive`  |  `bool`  |  If True, files from all subfolders are downloaded.  |  `True`  |  
|  `download_dir`  |  `Optional[str]`  |  Directory to download files to.  |  `None`  |  
Returns:  
| Type  | Description  |  
| --- | --- |  
|   |  List[Document]: A list containing the documents with metadata.  |  
...
list_resources(
    ...
    sharepoint_folder_path: Optional[] = None,
    sharepoint_folder_id: Optional[] = None,
    sharepoint_site_id: Optional[] = None,
    recursive:  = True,
) -> []
...
```
 |  
| --- | --- |  
###  get_site_pages_list_id [#](https://developers.llamaindex.ai/python/framework-api-reference/readers/microsoft_sharepoint/#llama_index.readers.microsoft_sharepoint.SharePointReader.get_site_pages_list_id "Permanent link")

```
get_site_pages_list_id(site_id: ) -> 
...
| Name  | Type  | Description  | Default  |  
| --- | --- | --- | --- |  
|  `site_id`  |  The ID of the SharePoint site.  |  _required_  |  
Returns:  
...
```
 |  
| --- | --- |  
###  list_pages [#](https://developers.llamaindex.ai/python/framework-api-reference/readers/microsoft_sharepoint/#llama_index.readers.microsoft_sharepoint.SharePointReader.list_pages "Permanent link")
...
| Type  | Description  |  
| --- | --- |  
|  `List[Dict[str, Any]]`  |  List[Dict[str, Any]]: List of page dictionaries with id, name, and lastModifiedDateTime.  |  
Source code in `llama-index-integrations/readers/llama-index-readers-microsoft-sharepoint/llama_index/readers/microsoft_sharepoint/base.py`  
| 
```
 994
...
```
 |  
| --- | --- |  
###  get_page_id_by_name [#](https://developers.llamaindex.ai/python/framework-api-reference/readers/microsoft_sharepoint/#llama_index.readers.microsoft_sharepoint.SharePointReader.get_page_id_by_name "Permanent link")
...
| --- | --- | --- | --- |  
|  `site_id`  |  The ID of the SharePoint site.  |  _required_  |  
|  `page_name`  |  The name of the page to find.  |  _required_  |  
Returns:  
| Type  | Description  |  
| --- | --- |  
|  `Optional[str]`  |  Optional[str]: The page ID if found, None otherwise.  |  
Source code in `llama-index-integrations/readers/llama-index-readers-microsoft-sharepoint/llama_index/readers/microsoft_sharepoint/base.py`  
| 
```
1032
...
```
 |  
| --- | --- |  
###  get_page_text [#](https://developers.llamaindex.ai/python/framework-api-reference/readers/microsoft_sharepoint/#llama_index.readers.microsoft_sharepoint.SharePointReader.get_page_text "Permanent link")

```
get_page_text(
    site_id: , list_id: , page_id: 
) -> [, ]
...
| --- | --- | --- | --- |  
|  `site_id`  |  The ID of the SharePoint site.  |  _required_  |  
|  `list_id`  |  The ID of the Site Pages list.  |  _required_  |  
|  `page_id`  |  The ID of the page (can be raw ID or combined listId:itemId).  |  _required_  |  
Returns:  
| Type  | Description  |  
| --- | --- |  
|  `Dict[str, Any]`  |  Dict[str, Any]: Dictionary containing page id, name, lastModifiedDateTime, textContent, and rawHtml.  |  
Source code in `llama-index-integrations/readers/llama-index-readers-microsoft-sharepoint/llama_index/readers/microsoft_sharepoint/base.py`  
| 
```
1067
...
```
 |  
| --- | --- |  
###  load_pages_data [#](https://developers.llamaindex.ai/python/framework-api-reference/readers/microsoft_sharepoint/#llama_index.readers.microsoft_sharepoint.SharePointReader.load_pages_data "Permanent link")
...
Loads SharePoint pages as Documents.
If self.sharepoint_file_id (combined page id) is provided, only process that page. Otherwise, process all pages.
Parameters:  
| Name  | Type  | Description  | Default  |  
| --- | --- | --- | --- |  
|  `download_dir`  |  `Optional[str]`  |  Directory to download files to (not used for pages, kept for API compatibility).  |  `None`  |  
Returns:  
| Type  | Description  |  
| --- | --- |  
|   |  List[Document]: A list of Document objects containing page content.  |  
...
```
 |  
| --- | --- |  
##  SharePointType [#](https://developers.llamaindex.ai/python/framework-api-reference/readers/microsoft_sharepoint/#llama_index.readers.microsoft_sharepoint.SharePointType "Permanent link")
Bases: `Enum`
...
```
 |  
| --- | --- |  
##  TotalPagesToProcessEvent [#](https://developers.llamaindex.ai/python/framework-api-reference/readers/microsoft_sharepoint/#llama_index.readers.microsoft_sharepoint.TotalPagesToProcessEvent "Permanent link")
Bases: `BaseEvent`
Event emitted when the total number of pages to process is known.
Source code in `llama-index-integrations/readers/llama-index-readers-microsoft-sharepoint/llama_index/readers/microsoft_sharepoint/event.py`  
| 
```
26
27
...
```
 | 
```
classTotalPagesToProcessEvent(BaseEvent):
"""Event emitted when the total number of pages to process is known."""
...
```
 |  
| --- | --- |  
##  PageDataFetchStartedEvent [#](https://developers.llamaindex.ai/python/framework-api-reference/readers/microsoft_sharepoint/#llama_index.readers.microsoft_sharepoint.PageDataFetchStartedEvent "Permanent link")
Bases: `BaseEvent`
...
```
 | 
```
classPageDataFetchStartedEvent(BaseEvent):
"""Event emitted when fetching data for a page starts."""
...
```
 |  
| --- | --- |  
##  PageDataFetchCompletedEvent [#](https://developers.llamaindex.ai/python/framework-api-reference/readers/microsoft_sharepoint/#llama_index.readers.microsoft_sharepoint.PageDataFetchCompletedEvent "Permanent link")
Bases: `BaseEvent`
...
```
 | 
```
classPageDataFetchCompletedEvent(BaseEvent):
"""Event emitted when fetching data for a page completes."""
...
```
 |  
| --- | --- |  
##  PageSkippedEvent [#](https://developers.llamaindex.ai/python/framework-api-reference/readers/microsoft_sharepoint/#llama_index.readers.microsoft_sharepoint.PageSkippedEvent "Permanent link")
Bases: `BaseEvent`
...
```
 | 
```
classPageSkippedEvent(BaseEvent):
"""Event emitted when a page is skipped (e.g., filtered out by callback)."""
...
```
 |  
| --- | --- |  
##  PageFailedEvent [#](https://developers.llamaindex.ai/python/framework-api-reference/readers/microsoft_sharepoint/#llama_index.readers.microsoft_sharepoint.PageFailedEvent "Permanent link")
Bases: `BaseEvent`
...
```
 | 
```
classPageFailedEvent(BaseEvent):
"""Event emitted when processing a page fails."""
